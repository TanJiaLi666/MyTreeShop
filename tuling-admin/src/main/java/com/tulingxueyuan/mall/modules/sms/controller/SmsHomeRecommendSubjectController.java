...
public class SmsHomeRecommendSubjectController {
    ...
    @ApiOperation("加载推荐列表")
    @GetMapping("/list")
    public CommonResult<CommonPage<SmsHomeRecommendSubject>> fetchList(@RequestParam(value = "pageNum", defaultValue="1") Integer pageNum,
                                                                       @RequestParam(value = "pageSize", defaultValue="5") Integer pageSize) {
        Page<SmsHomeRecommendSubject> page = recommendSubjectService.fetchList(pageNum, pageSize);
