...
public class JwtTokenUtil {
    public static ThreadLocal<Map<String, Object>> menberName = new ThreadLocal<>();
     ...
     */
    public String generateUserNameStr(@NonNull String username, String password, String nickname) {
